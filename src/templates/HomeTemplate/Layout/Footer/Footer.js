                ...
                <div className="col col-12 col-md-4">
                    <div className="row">
                        <div className="col col-6 mobile d-none d-lg-block">
                            ...
                            <div className="d-flex">
                                <a href="#">
                                    <img className="mx-1.5 md:ml-0 md:mr-2.5" src="/images/logo-apple.png" alt=''/>
                                </a>
                                <a href="#">
                                    <img className="mx-1.5 md:ml-0 md:mr-2.5" src="/images/logo-android.png" alt=''/>
                                </a>
                            </div>
                        </div>
                        <div className="col col-12 col-md-6 social">
                            ...
                            <div className="d-flex justify-center md:justify-start">
                                <a href="#">
                                    <img className="mx-1.5 md:ml-0 md:mr-2.5" src="/images/logo-facebook.png" alt=''/>
                                </a>
                                <a href="#">
                                    <img className="mx-1.5 md:ml-0 md:mr-2.5" src="/images/logo-zalo.png" alt=''/>
                                </a>
                            </div>
                        </div>
                    </div>
